...
def make_irrev_constant(stoichiometry):
    ...
    class IrrevConstant(KineticMechanism):
        """A Irev N-M constant flux class """
    ...
    IrrevConstant.__name__ += IrrevConstant.suffix

    return IrrevConstant