...
from skimpy.utils.constructors import reversible_michalies_menten_from_thermo_data
...
## QSSA Method
parameters = reversible_michalies_menten_from_thermo_data(thermo_data_pfk)
