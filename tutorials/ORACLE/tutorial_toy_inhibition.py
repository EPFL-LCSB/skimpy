...
"""
df_regulations_all = {}
df_regulations_all['0'] = {'reaction_id':'PGK', 'regulator':'_3pg_c', 'regulation':'competitive inhibition'}
df_regulations_all['1'] = {'reaction_id':'PGK', 'regulator':'atp_c', 'regulation':'activation'}
df_regulations_all['2'] = {'reaction_id':'ENO', 'regulator':'adp_c', 'regulation':'competitive inhibition'}
import pandas as pd
df_regulations_all = pd.DataFrame(df_regulations_all)
df_regulations_all = df_regulations_all.T
...
# Load the regulations into the kinetic model
this_skimpy_model = load_enzyme_regulation(kmodel,df_regulations_all)
...
"""
this_skimpy_model.parameters.km_substrate1_ENO.bounds = (1e-4, 1e-3)
this_skimpy_model.parameters.km_product1_ENO.bounds = (1e-4, 1e-3)
